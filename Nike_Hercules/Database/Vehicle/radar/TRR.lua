...
GT.visual.shape = "TRR_V0";
GT.visual.shape_dstr = "TRR_V0";
...
GT.WS.searchRadarFrequencies = {4910.0e6, 5090.0e6};--{{15.7e9, 17.5e9}}; 
...
GT.WS[ws].LN[1].frequencyRange = {15.7e9, 17.5e9};

GT.Name = "Nike-Hercules TRR";
GT.DisplayName = _("Nike-Hercules Target Ranging Radar");
GT.DisplayNameShort = _("Nike-Hercules TRR");
GT.Rate = 10;
