...
GT.visual.shape = "MTR_TTR_V1";
GT.visual.shape_dstr = "MTR_TTR_V1";
...
GT.Name = "Nike-Hercules TTR";
GT.DisplayName = _("Nike-Hercules Target Tracking Radar");
GT.DisplayNameShort = _("Nike-Hercules TTR");
GT.Rate = 10;
