-- MIM-14B Nike-Hercules Launcher
-- By SirPueo
...
GT.Name = "Nike Hercules ln_B_GER";
GT.DisplayName = _('Nike Hercules Single Launcher_B (GER)');
GT.DisplayNameShort = _("Nike Hercules LN_B (GER)");
GT.Rate = 10;
GT.DetectionRange  = 0;
