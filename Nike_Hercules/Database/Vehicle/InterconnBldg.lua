-- MIM-14 Nike-Hercules Interconnection Building

GT = {};
set_recursive_metatable(GT, GT_t.generic_stationary)
set_recursive_metatable(GT.chassis, GT_t.CH_t.MAZ543M);

GT.visual.shape = "IntBldg"
GT.visual.shape_dstr = "IntBldg"
...
GT.Name = "Nike-Hercules Int Bldg"
GT.DisplayName = _('Nike-Hercules Interconnection Building')
GT.DisplayNameShort = _('Nike-Hercules Inter Bldg')
GT.Rate = 3;
