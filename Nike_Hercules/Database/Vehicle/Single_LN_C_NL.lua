...
GT.WS[ws] = {};
set_recursive_metatable(GT.WS[ws], GT_t.WS_t.NikeHerculesC_NL);
GT.WS[ws].pos = {0, 0, 0};
...
GT.Name = "Nike Hercules ln_C_NL";
GT.DisplayName = _('Nike Hercules Single Launcher_C (NL)');
GT.DisplayNameShort = _("Nike Hercules LN_C (NL)");
GT.Rate = 10;
...
GT.Countries = {"USA","The Netherlands"};
