...
local MIM14C = {
	name = MIM14C,
	display_name = _('MIM-14C Nike Hercules'),
	display_name_short = _('MIM-14C Nike Hercules'),
	name = "MIM14C",
...
declare_weapon(MIM14C)

GT_t.WS_t.NikeHerculesC = {}
GT_t.WS_t.NikeHerculesC.moveable = false
GT_t.WS_t.NikeHerculesC.angles = {
					{math.rad(180), math.rad(-180), math.rad(-90), math.rad(90)},
					};

GT_t.WS_t.NikeHerculesC.LN = {}
GT_t.WS_t.NikeHerculesC.LN[1] = {}
GT_t.WS_t.NikeHerculesC.LN[1].type = 4
GT_t.WS_t.NikeHerculesC.LN[1].distanceMin = 6500;
GT_t.WS_t.NikeHerculesC.LN[1].distanceMax = 155000;
GT_t.WS_t.NikeHerculesC.LN[1].ECM_K = 0.3; -- Notional susceptibility to chaff and ECM (mostly handled through other mechanics, but a -1 means no effect, often seen with IR missiles). 
GT_t.WS_t.NikeHerculesC.LN[1].reactionTime = 4; --Acquisition time for the weapon sighting system (should correspond to that of the the carrying vehicle but may be overwritten depending on sensors and data-linking capabilities).
GT_t.WS_t.NikeHerculesC.LN[1].launch_delay = 6; --Time in seconds between successive missile launches (time to ready new missile). 
GT_t.WS_t.NikeHerculesC.LN[1].reflection_limit = 0.02;
GT_t.WS_t.NikeHerculesC.LN[1].show_external_missile = true;
GT_t.WS_t.NikeHerculesC.LN[1].sensor = {}
set_recursive_metatable(GT_t.WS_t.NikeHerculesC.LN[1].sensor, GT_t.WSN_t[0])
GT_t.WS_t.NikeHerculesC.LN[1].beamWidth = math.rad(1);
GT_t.WS_t.NikeHerculesC.LN[1].PL = {}
GT_t.WS_t.NikeHerculesC.LN[1].PL[1] = {}
GT_t.WS_t.NikeHerculesC.LN[1].PL[1].ammo_capacity = 1;
GT_t.WS_t.NikeHerculesC.LN[1].PL[1].type_ammunition = MIM14C.wsTypeOfWeapon;
GT_t.WS_t.NikeHerculesC.LN[1].PL[1].reload_time = 15*60; -- 15 minutes
GT_t.WS_t.NikeHerculesC.LN[1].BR = { {pos = {0, 0, 0} } }
